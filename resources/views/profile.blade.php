        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-body bg-white">
                    ...
                    <p class="fs-5 mb-1 fw-semibold">Selamat datang di halaman profil, <span class="fw-semibold">{{ $username }}</span>!</p>
                    ...
                    <div class="mt-4">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                <span><strong>Email:</strong> {{ $email ?? 'user@example.com' }}</span>
                                <button class="btn btn-sm btn-outline-primary">Edit</button>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">
