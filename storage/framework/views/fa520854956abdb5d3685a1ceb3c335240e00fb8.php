...
<?php $__env->startSection('content'); ?>
    <div class="container mt-5">
        <div class="card bg-emphasis-color text-danger mb-4">
            <div class="card-body">
                <h4 class="card-title fs-1 fw-bold mb-7">Selamat datang, <?php echo e($username); ?>!</h4>
            ...
            <div class="col-md-4 mb-3">
                <div class="card h-100">
                    <div class="card-body bg-primary text-white">
                        ...
                        <a href="<?php echo e(route('pengelolaan')); ?>" class="btn btn-danger btn-sm mb-2">Lihat Koleksi</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card h-100">
                    <div class="card-body bg-success text-white">
                        ...
                        <a href="<?php echo e(route('riwayat')); ?>" class="btn btn-danger btn-sm mt-4">Lihat Riwayat</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 mb-3">
                <div class="card h-100">
                    <div class="card-body bg-warning text-white">
                        ...
                        <a href="<?php echo e(route('sedangDibaca')); ?>" class="btn btn-danger btn-sm text-white mt-5">Lihat Progres</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\acer\uts-praktikum\resources\views/dashboard.blade.php ENDPATH**/ ?>